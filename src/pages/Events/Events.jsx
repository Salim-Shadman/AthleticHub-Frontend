...
const Events = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="mb-12 max-w-2xl mx-auto flex flex-col sm:flex-row gap-4">
                ...
                <div className="form-control">
                     <select 
                        className="select select-bordered w-full sm:w-auto shadow-sm"
                        value={sortOrder}
                    ...
                    {filteredEvents.map((event, index) => (
                        ...
                        >
                            <figure>
                                ...
                                <img 
                                    src={event.image || 'https://i.ibb.co/wJ3R4bg/placeholder-image.png'} 
                                    alt={event.eventName} 
